...
const Footer = () => {
    ...
    return (
        ...
        }} className="footer p-10 bg-base-300 text-base-content px-5 mb-3">
            <div>
        ...
        <div>
            <p className='text-white text-center mb-5'>Copyright By Md. Nasir &copy;{new Date().getFullYear()} All right reserved</p>
        </div>
        </>
    );
};
